        ...
        public sealed class Conv3d : Convolution
        {
            ...
            public override Tensor forward(Tensor input)
            {
                ...
                if (padding_type.HasValue)
                    return torch.nn.functional.conv3d_padded(input, weight, bias, stride, padding_type.Value, dilation, groups);
    ...
    public static partial class torch
    {
        public static partial class nn
        {
            ...
            public static partial class functional
            {
                ...
                /// <param name="groups">Number of blocked connections from input channels to output channels. Default: 1</param>
                /// <returns></returns>
                public static Tensor conv3d_padded(Tensor input, Tensor weight, Tensor? bias = null,
                    long[]? strides = null,
                    ...
                    long groups = 1)
                {
                    ...
                    unsafe {
                        fixed (long* pstrides = strides, pdilation = dilation) {
                            var res =
                                THSTensor_conv3d_padded(input.Handle, weight.Handle, biasHandle,
                                    (IntPtr)pstrides, strides.Length,
                                    (int)padding,
                                    (IntPtr)pdilation, dilation.Length,
                                    groups);
